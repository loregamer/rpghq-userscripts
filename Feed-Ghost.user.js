...
(function () {
  ...
  // Handle viewonline.php replacement first, before any other functionality
  if (window.location.href.includes("/viewonline.php")) {
    // URL of the board index
    const sourceURL = "https://rpghq.org/forums/index.php";

    // Fetch and replace content before initializing anything else
    fetch(sourceURL)
    ...
    // For all other pages, initialize directly
    document.addEventListener("DOMContentLoaded", initializeScript);
  }

  // Main initialization function that contains all our functionality
