...
(function () {
    ...
    var hasRequiredInitCore;

    function requireInitCore () {
    	if (hasRequiredInitCore) return initCore;
    	hasRequiredInitCore = 1;
    ...
    var initCoreExports = requireInitCore();
