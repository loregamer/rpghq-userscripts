...
if (typeof GM_addStyle === "function") {
    GM_addStyle(css);
    console.log("RPGHQ Manager: Styles injected via GM_addStyle from injectStyles.js.");
} else {
    ...
    console.warn("RPGHQ Manager: Using fallback style injection from injectStyles.js.");
}
