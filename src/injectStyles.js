...
GM_addStyle(`
  ...
  /* --- User Preferences Search Modal Styles --- */
  /* (Adapted from memberSearch.js, namespaced for this specific use) */
  .hq-usm-user-search-modal {
      display: none;
      position: fixed;
      top: 0;
      left: 0;
      ...
      z-index: 1200000; /* Higher than settings modal */
      justify-content: center;
      align-items: center;
  }
  .hq-usm-user-search-modal.active {
      display: flex;
  }
  .hq-usm-user-search-modal .member-search-container {
  ...
  .hq-usm-user-search-modal .member-search-close {
      position: absolute;
      top: 10px;
      right: 10px;
      font-size: 20px;
  ...
  .hq-usm-user-search-modal .member-search-close:hover {
      color: var(--danger-color);
  }
  .hq-usm-user-search-modal .member-search-title {
      font-size: 18px;
      margin-bottom: 15px;
      color: var(--text-primary);
      text-align: center;
  }
  .hq-usm-user-search-modal .member-search-input {
      width: calc(100% - 20px);
      padding: 8px 10px;
      border: 1px solid var(--border-color);
      border-radius: 4px;
  ...
  .hq-usm-user-search-modal .member-search-input:focus {
      outline: none;
      border-color: var(--primary-color);
  }
  .hq-usm-user-search-modal .member-search-results {
      max-height: 250px; /* Keep explicit height */
      overflow-y: auto;
  ...
  .hq-usm-user-search-modal .member-search-result {
      display: flex;
      align-items: center;
      padding: 8px 10px;
      cursor: pointer;
      border-radius: 0; /* Flat look inside results container */
      border-bottom: 1px solid var(--border-color);
  }
   .hq-usm-user-search-modal .member-search-result:last-child {
       border-bottom: none;
   }
  .hq-usm-user-search-modal .member-search-result:hover {
      background-color: rgba(255, 255, 255, 0.05);
  }
  .hq-usm-user-search-modal .member-search-result img {
      width: 32px;
      height: 32px;
      border-radius: 50%;
      margin-right: 10px;
  ...
  .hq-usm-user-search-modal .member-search-result span {
      white-space: nowrap;
      overflow: hidden;
      text-overflow: ellipsis;
      color: var(--text-primary);
  }
  .hq-usm-user-search-modal .member-search-no-results,
  .hq-usm-user-search-modal .member-search-loading {
      padding: 10px;
      color: var(--text-secondary);
      text-align: center;
  }
  /* --- End User Preferences Search Modal Styles --- */
