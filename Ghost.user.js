...
// @version      5.9.1
// @description  Hides content from ghosted users, with enhanced user management (search), quote→blockquote formatting, hides posts with @mentions of ghosted users
// @author       You
