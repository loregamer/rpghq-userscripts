...
const numberCommas = {
    documentStart: function (id, data) {
        "use strict";

        // Get settings from the script manager
        const formatFourDigits = data.settings.formatFourDigits || false;

        const numberRegex = formatFourDigits ? /\b\d{4,}\b/g : /\b\d{5,}\b/g;

        processElements();
    },
    documentReady: function (id, data) {
        "use strict";
